...
function OrdenesSecuenciadasLin(){
    ...
    return(
        ...
        <div className='fondo'>
            <h1 style={{color:"white"}}>Ordenes secuenciadas lin</h1>
            ...
            {isLoading ? ( 
                ...
                <ul>
                    {OrdenesSecuenciadas
                        .filter(item => item.Vista === "OrdenesSecuenciadasLin")
...
export default OrdenesSecuenciadasLin;