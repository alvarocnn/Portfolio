...
function OrdenesSecuenciadasRuta(){
    ...
    return(
        ...
        <div className='fondo'>
            <h1 style={{color:"white"}}>Ordenes secuenciadas ruta</h1>
            ...
            {isLoading ? ( 
                ...
                <ul>
                    {OrdenesSecuenciadas
                        .filter(item => item.Vista === "OrdenesSecuenciadasRuta")
...
export default OrdenesSecuenciadasRuta;